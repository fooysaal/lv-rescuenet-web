...
@section('title_bn', 'পেজ খুঁজে পাওয়া যায়নি')
...
@section('message')
    Oops! The page you're looking for seems to have gone missing during our rescue operations. Don't worry, we'll help you
    get back on track.
@endsection

@section('message_bn')
    উপস! আপনি যে পেজটি খুঁজছেন সেটি আমাদের রেসকিউ অপারেশনের সময় হারিয়ে গেছে বলে মনে হচ্ছে। চিন্তা করবেন না, আমরা আপনাকে
    সঠিক পথে ফিরিয়ে দেব।
@endsection
...
@section('additional_content')
    ...
    <div class="pt-4">
        ...
        <p class="lang-bn lang-hidden text-sm text-gray-500 italic font-bangla">
            💡 টিপস: URL এ কোনো ভুল আছে কিনা চেক করুন, বা আপনার প্রয়োজনীয় জিনিস খুঁজতে উপরের নেভিগেশন ব্যবহার করুন।
        </p>
    </div>
@endsection
